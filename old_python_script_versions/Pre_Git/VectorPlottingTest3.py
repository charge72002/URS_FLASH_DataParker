...
color = np.hypot(velXarray, velYarray) #colorcode arrows by magnitude
plt.quiver(posXarray, posYarray, velXarray, velYarray, color, width=0.002, 
           headwidth = 1, scale = 1)
#plt.scatter(posXarray, posYarray, color='0.5', s=1)

plt.savefig('Plots/VelocityPlot_m2_c1_0076_v2.png', dpi=1000);
print("Done.")