...
print(dict['coordinates'][:][1])
print(dict['coordinates'][:][2])
print(dict['coordinates'][:][3])
...
# with open('m2_c1_0076_data2.csv', 'w', newline='') as csvfile:
...
plt.savefig('Plots/VelocityPlot_m2_c1_0076_Ycolor2.png', dpi=1000);
